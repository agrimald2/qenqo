<template>
    <div class="max-w-sm w-full h-full bg-white rounded-lg shadow  p-4 md:p-6">
        ...
        <div class="grid grid-cols-1 items-center border-gray-200 border-t  justify-between">
            <div class="flex justify-between items-center pt-5">
                ...
                <a href="#"
                    class="uppercase text-sm font-semibold inline-flex items-center rounded-lg text-purple-600 hover:text-purple-700 dark:hover:text-purple-500  hover:bg-gray-100  dark:focus:ring-gray-700  px-3 py-2">
                    Users Report
