<template>
    <div class="max-w-sm w-full h-full bg-white rounded-lg shadow  p-4 md:p-6">
        <div class="flex justify-between mb-5">
                ...
                <div>
                    <h5 class="inline-flex items-center text-gray-500  leading-none font-normal mb-2">
                        ...
                        <svg data-popover-target="clicks-info" data-popover-placement="bottom"
                            class="w-3 h-3 text-gray-400 hover:text-gray-900  cursor-pointer ml-1"
                        ...
                        <div data-popover id="clicks-info" role="tooltip"
                            ...
                            <div class="p-3 space-y-2">
                                ...
                                <a href="#"
                                    class="flex items-center font-medium text-purple-600 dark:text-purple-500 dark:hover:text-purple-600 hover:text-purple-700 hover:underline">Read
            ...
            <div>
                <button id="dropdownDefaultButton" data-dropdown-toggle="lastDaysdropdown" data-dropdown-placement="bottom"
                    type="button"
                    class="px-3 py-2 inline-flex items-center text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-purple-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700     ">Last
                    week <svg class="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 10 6">
        ...
        <div class="grid grid-cols-1 items-center border-gray-200 border-t  justify-between mt-2.5">
            <div class="pt-5">
                <a href="#"
                    class="px-5 py-2.5 text-sm font-medium text-white inline-flex items-center bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 rounded-lg text-center   ">
